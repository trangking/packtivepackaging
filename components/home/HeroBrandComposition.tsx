...
export function HeroBrandComposition() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute left-[5%] top-[9%] h-[76%] w-[90%] rounded-[999px] bg-white/86 shadow-[0_44px_120px_rgba(110,18,15,0.12)] blur-2xl" />
      ...
      <motion.div
        className="absolute left-[2%] top-[5%] z-20 h-[88%] w-[96%] sm:top-[7%] sm:h-[84%]"
      ...
      >
        <motion.div
          ...
          animate={
            shouldReduceMotion
              ? undefined
              : { y: [0, -14, 0], rotate: [0, -0.5, 0], scale: [1, 1.006, 1] }
          }
          transition={{ duration: 9.5, repeat: Infinity, ease: "easeInOut" }}
        >
          <Image
            src="/PacktivePackaging/image/img3/100G.jpg.webp"
            alt="กระปุกครีมภาพสินค้าจริง Packtive Packaging"
            fill
            priority
            sizes="(min-width: 1280px) 52vw, (min-width: 1024px) 48vw, 94vw"
            className="object-cover drop-shadow-[0_38px_68px_rgba(23,23,23,0.16)]"
          />
        </motion.div>
      </motion.div>
    </div>
